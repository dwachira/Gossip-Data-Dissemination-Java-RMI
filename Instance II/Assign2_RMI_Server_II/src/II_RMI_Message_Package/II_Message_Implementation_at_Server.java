...
public class II_Message_Implementation_at_Server  extends UnicastRemoteObject implements II_Message 
{
    ...
    public String Pass_Message(String Message_Received) throws RemoteException 
    {
      ...
      *                                                       *
      ********************************************************/
        //System.out.println("Message received by Instance II ["+ Message_Received+"]");
        
        
        New_Object_for_Class_RMI_Server_Main_Method.Log_Information_to_Text_file("Message received by Instance II ["+ Message_Received+"]");
        JOptionPane.showMessageDialog(null, ""+ Message_Received, "Message Received - Instance II", JOptionPane.INFORMATION_MESSAGE);
