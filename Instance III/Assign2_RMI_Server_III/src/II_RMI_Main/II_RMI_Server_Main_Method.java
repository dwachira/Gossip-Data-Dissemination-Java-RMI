...
public class II_RMI_Server_Main_Method {
    ...
    private void Start_RMI_Server(){
        try { 
            Log_Information_to_Text_file ("Starting Server - Instance 3");
      /********************************************************
      *                                                       *
      *   The Port assigned is Port Number 2203               *
      *                                                       *
      ********************************************************/
            Registry registry = LocateRegistry.createRegistry(2203);
            Log_Information_to_Text_file ("Port 2203 dedicated for the Creation of a New Service"); 
      ...
      *                                                       *
      ********************************************************/
            registry.rebind("New_Message_Service_Instance_3", new II_Message_Implementation_at_Server());
            Log_Information_to_Text_file ("New_Message_Service_Instance_3 created");
            
        } catch (Exception e) {
            e.printStackTrace();
            Log_Information_to_Text_file ("Error within Start_RMI_Server() --> "+e);
        } 
        Log_Information_to_Text_file ("Instance III is Ready; Listening on Port 2203");
   ...
   public void Test_Message_Implementation()
   {
      ...
      *   Client screen                                       *
      ********************************************************/        
            String Message_to_be_Communicated = II_Message_Implementation_at_Server.Msg_Update_Received +" - Update by Instance III";
