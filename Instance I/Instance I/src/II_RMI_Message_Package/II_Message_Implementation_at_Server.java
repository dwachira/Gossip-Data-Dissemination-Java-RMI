...
public class II_Message_Implementation_at_Server  extends UnicastRemoteObject implements II_Message 
{
    ...
    public String Pass_Message(String Message_Received) throws RemoteException 
    {
      ...
      *                                                       *
      ********************************************************/
        //System.out.println("Message received by Instance I  ["+ Message_Received+"]");
        New_Object_for_Class_RMI_Server_Main_Method.Log_Information_to_Text_file("Message received by Instance I ["+ Message_Received+"]");
        JOptionPane.showMessageDialog(null, ""+ Message_Received, "Message Received - Instance I", JOptionPane.INFORMATION_MESSAGE);
        ...
        Write_To_Infection_File file_update_write_I = new Write_To_Infection_File();
        file_update_write_I.Write_To_Infection_File();
