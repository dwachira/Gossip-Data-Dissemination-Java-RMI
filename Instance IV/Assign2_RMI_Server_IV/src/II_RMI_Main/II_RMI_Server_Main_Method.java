...
public class II_RMI_Server_Main_Method {
    ...
    private void Start_RMI_Server(){
        try { 
            Log_Information_to_Text_file ("Starting Server - Instance 4");
      /********************************************************
      *                                                       *
      *   The Port assigned is Port Number 2204               *
      *                                                       *
      ********************************************************/
            Registry registry = LocateRegistry.createRegistry(2204);
            Log_Information_to_Text_file ("Port 2204 dedicated for the Creation of a New Service"); 
      ...
      *                                                       *
      ********************************************************/
            registry.rebind("New_Message_Service_Instance_4", new II_Message_Implementation_at_Server());
            Log_Information_to_Text_file ("New_Message_Service_Instance_4 created");
            
        } catch (Exception e) {
            e.printStackTrace();
            Log_Information_to_Text_file ("Error within Start_RMI_Server() --> "+e);
        } 
        Log_Information_to_Text_file ("Instance IV is Ready; Listening on Port 2204");
...
//            }
      ...
      *   Client screen                                       *
      ********************************************************/        
            String Message_to_be_Communicated = II_Message_Implementation_at_Server.Msg_Update_Received +" - Update by Instance IV";
